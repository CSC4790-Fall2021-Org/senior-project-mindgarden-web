 ...
 <div className="w-full max-w-md mx-auto">
  ...
  <div className="max-w-md w-full mx-auto h-3/6  mt-4 bg-darkWhite rounded p-8 rounded neoShadow">
    ...
    <div>
        ...
        <div>
        <label htmlFor="" className="text-md font-bold font-mada text-gray-600 block ml-1">Confirm Password</label>
        ...
        })}   type="password" className="w-full  neoShadow p-3 mt-1 bg-darkWhite mx-auto outline-none" placeholder="**********" name="confirmPassword" />
        <div className="text-md font-mada text-red-600 ml-2">
