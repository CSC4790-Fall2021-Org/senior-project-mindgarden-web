  ...
  return (
    <AnimatePresence>
      {props.isOpen && (
        ...
        >
          <motion.div
            className={`${props.size} top-1/2 left-1/2 absolute bg-darkWhite rounded-lg transform -translate-x-1/2 -translate-y-1/2 opacity-100 flex justify-center items-center`}
            initial={"initial"}
            animate={"isOpen"}
            exit={"exit"}
